...
public class CustomDragonControllerHold2 extends DragonControllerHold {
  private PathEntity b;
  private Vec3D c;
  private boolean d;

  public CustomDragonControllerHold2(EntityEnderDragon var1) {
    super(var1);
  }
...
//        --var2;
      ...
      this.b = this.a.a(var6, var2, (PathPoint)null);
      if(this.b != null) {
        this.b.a();
      }
    }
...
//    ((DragonControllerStrafe)this.a.getDragonControllerManager().b(DragonControllerPhase.b)).a(var1);
//  }
