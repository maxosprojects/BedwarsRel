...
public class CustomEnderDragon extends EntityEnderDragon {
  ...
  public CustomEnderDragon(World world, final Set<Player> friendlyPlayers, Location top) {
    super(world);
    this.friendlyPlayers = friendlyPlayers;
    CustomDragonControllerManager controllerManager = new CustomDragonControllerManager(this, friendlyPlayers, top);
  ...
  public static EnderDragon spawn(Location location, Set<Player> friendlyPlayers) {
    ...
    CustomEnderDragon customEnderDragon = new CustomEnderDragon(nmsWorld, friendlyPlayers, location);
  ...
  public static Set<Player> getFriendlies(EnderDragon dragon) {
    EntityEnderDragon nmsDragon = ((CraftEnderDragon) dragon).getHandle();
    if (nmsDragon instanceof CustomEnderDragon) {
      return ((CustomEnderDragon) nmsDragon).friendlyPlayers;
    }
    return null;
  }
