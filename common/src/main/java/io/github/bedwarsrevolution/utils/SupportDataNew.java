...
public class SupportDataNew {

  public static String getBukkitVersion() {
    return BedwarsRevol.getInstance().getServer().getBukkitVersion();
  }

  public static File getConfigFile() {
    File configFile = new File(BedwarsRevol.getInstance().getDataFolder(), "config.yml");
    File tmp = null;
    ...
    try {
      tmp = File.createTempFile("bedwarsrevol-supportdata-config", null);
      config.save(tmp);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public static String getPluginVersion() {
    ...
    return BedwarsRevol.getInstance().getDescription().getVersion();
  }

  public static String[] getPluginVersionArray() {
    return BedwarsRevol.getInstance().getDescription().getVersion().split("-");
  }
  ...
  public static String getPluginVersionType() {
    if (BedwarsRevol.getInstance().getDescription().getVersion().contains("SNAPSHOT")) {
      return "SNAPSHOT";
    }
    return "RELEASE";
  }
  ...
  public static ArrayList<String> getPlugins() {
    ...
    Plugin[] plugins = BedwarsRevol.getInstance().getServer().getPluginManager().getPlugins();
  ...
  public static String getServerVersion() {
    return BedwarsRevol.getInstance().getServer().getVersion();
  }

  public static File getShopConfigFile() {
    return new File(BedwarsRevol.getInstance().getDataFolder(), "shop.yml");
  }
}
