...
public class ClearSpawnerCommand extends BaseCommand implements ICommand {
  ...
  public ClearSpawnerCommand(BedwarsRevol plugin) {
    super(plugin);
  }
...
//                ._l(sender, "success.spawnercleared")));
  ...
  public String getDescription() {
    return BedwarsRevol._l("commands.clearspawner.desc");
  }

  @Override
  public String getName() {
    return BedwarsRevol._l("commands.clearspawner.name");
  }
