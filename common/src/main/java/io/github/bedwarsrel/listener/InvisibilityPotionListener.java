...
import static io.github.bedwarsrel.listener.InvisibilityPotionListener.Parts.CHEST;
import static io.github.bedwarsrel.listener.InvisibilityPotionListener.Parts.FEET;
import static io.github.bedwarsrel.listener.InvisibilityPotionListener.Parts.HEAD;
import static io.github.bedwarsrel.listener.InvisibilityPotionListener.Parts.LEGS;
...
public class InvisibilityPotionListener extends BaseListener {
  ...
  public void onConsumeEvent(PlayerItemConsumeEvent event) {
    ...
    if (item.getType() == Material.POTION) {
      try {
        Class<?> hiderClass = BedwarsRel.getInstance().getVersionRelatedClass("HideArmor");
